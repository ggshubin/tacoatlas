...
| Create | `src/data/__tests__/mi-gente-stubs.test.ts` | Type shape + data integrity tests |
...
- Create: `src/data/__tests__/mi-gente-stubs.test.ts`
...
npx jest src/data/__tests__/mi-gente-stubs.test.ts --no-coverage
```
...
```bash
git add src/data/mi-gente-stubs.ts src/data/__tests__/mi-gente-stubs.test.ts
